...
public class OrderPizzaTestStep  extends Driver{
	...
	/*
	 * @When("he redirects to orderPage") public void he_redirects_to_order_page() {
	 * placeOrder.continueorder(); }
	 */

	/*
	 * @When("he adds first item to cart") public void he_adds_first_item_to_cart()
	 * { placeOrder.moveToCart(); }
	 */

	
	  @When("he click on checkout button") public void
	 he_click_on_checkout_button() { placeOrder.checkoutAction();
	 
	  }
	 
	@Then("the page title should be Secure Checkout")
	public void the_page_title_should_be_secure_checkout() {
		String expectedTitle = "SECURE CHECKOUT";
		String actualTitle = checkOut.getMsg();
